...
class NoteCommentsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let userImagePath = "https://mb.api.cloud.nifty.com/2013-09-01/applications/qS98cF8iYWpyAH8E/publicFiles/" + user.objectId
